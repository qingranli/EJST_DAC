# Get post-lasso logistic regression result (DAC ~ indicators)
# save 1 data file for main Fig 4: DAC_postLasso_1SE.RData
# save 1 data file for Supp. Fig 5: DAC_postLasso_minE.RData
# author: Qingran Li
...
# match to census tract in 2019 and 2020 map using the crosswalk
...
#####################################################################
toolName = "DOT"   # select tool (CEJST, DOE, DOT, NYS)
if (is.null(toolName)){
...
message(sprintf("[%s] Post-LASSO logistic regfit object saved.", toolName))
...
saveRDS(regfitList, file="DAC_postLasso_1SE.RData")
...
regfitList[[3]] = regfit_dot
regfitList[[4]] = regfit_nys
saveRDS(regfitList, file="DAC_postLasso_minE.RData")
